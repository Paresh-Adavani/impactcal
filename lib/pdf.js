...
function render(q, company, bank, opts = {}) {
  return new Promise((resolve, reject) => {
    ...
    const bl = q.currency === 'USD'
      ? [['Beneficiary', b.beneficiary], ['Bank', b.bank], ['Branch', b.branch], ['Account no.', b.account], ['SWIFT / BIC', b.swift], ['IFSC / AD code', b.ad_code], ['Correspondent bank', b.correspondent]]
