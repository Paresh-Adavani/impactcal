...
/** Wire rope isolator lug options: settings wri.lug_options "EN8D + Arkor treated=0; EN8D + Zinc plated=0; Aluminium alloy=2; SS 304=5"
 *  (label = surcharge % on the list price; the first one is the standard build). */
function lugOptions(s) {
  const raw = String((s && s['wri.lug_options']) || 'EN8D + Arkor treated=0; EN8D + Zinc plated=0; Aluminium alloy=2; SS 304=5');
